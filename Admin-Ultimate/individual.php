        ...
        <div class="content-wrapper">
          ...
          if(!isset($_REQUEST['pending']))
           {
            ...
            count(type) as totalrooms,avg(rating) as rating  FROM local_admin JOIN rooms 
            ON local_admin.id=rooms.local_admin_id 
            JOIN review ON local_admin.id=review.local_admin_id
           ...
           else
           {
            ...
            where local_admin.id=? AND lodge_status=0
            GROUP BY TYPE");
            $sql_all_details->bind_param("i",$local_admin_id);
            $sql_all_details->execute();
            $result= $sql_all_details->get_result();
         ...
         <div class="row bg-white pt-3">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                   ...
                   <div class="row  mb-3 border-bottom">
                      ...
                      <div class="col-md-6"><?php echo round($row['rating'],1)."/5" ?></div>
                   </div> 
                    <?php
                          }
            ...
            ?>
             ...
             <div class="modal fade" id="myModal-approval">
                ...
                <div class="modal-content">
                   ...
                   Do you wish to approve this lodge?
                    </div>
                    <?php
                      if(isset($_POST['appi']))
                      {
                        ...
                        $approve=$db_connection->prepare("UPDATE local_admin SET lodge_status=1 WHERE id=?");
                  ...
                  ?>
                    ...
                    <input type="text" hidden="true" value="default" name="appi" id="appi">
                    <input type="submit" name="approve" class="btn btn-success" value="Approve"
                    data-dismiss="modal" id="approve" onclick="form_submit()">
...
$('.dataTables_length').addClass('bs-select');
   ...
   <script>
      ...
      function submit_form()
      {
         ...
         document.getElementById('remove_button').submit();
