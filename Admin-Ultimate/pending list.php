            ...
            <div class="col-sm-12">
                <form action="#">
                    ...
                    <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                      ...
                      <tbody>
                          <?php
                            $sql_select_pending_list = $db_connection->prepare("SELECT * FROM 
                            local_admin WHERE lodge_status= 0");
                            $sql_select_pending_list->execute();
                            $result=$sql_select_pending_list->get_result();
                        ...
                        <tr>
                          ...
                          <td><?php echo $row['original_name']; ?></td>
                          <td><a href="individual.php?id=<?php echo $row['id'].'&pending=1'; ?>" class="btn btn-primary p-3">View</a></td>
                        </tr>   
                            <?php
                            $i++;
                            }
